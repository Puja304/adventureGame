...
string item::paintingCode(item& something){
    cout << "You move closer to the painting and observe a few strange words on it. They are: " << endl;
    cout << "ENVYING LOCAL" << endl;
    cout << "On the other end of the painting it says 'Jumble,' in a scrawl" << endl; 
    return "";
}

string item::foundSword(item& something){
       if(something.isSolved() == true){
        cout << "You have acquired the sword." << endl;
        return "";
        exit;
       }
       cout << "The sword has a giant fancy cuff attaching it to the wall. You try pulling it and are unsuccessful. You then see a little screen on the cuff, "
        "and it opens up to show a tiny keypad. The code takes in 3 words. Enter a code to try and open it, or enter 'x' to stop interacting with it" << endl;
        string code = "long live lycaon";
        string guess = "";
        while(true){
            try
            {   
